              ...
              <tbody className="divide-y divide-gray-200">
                {
                  value.map((office, index) => (
                    <tr key={index}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><a href={`mailto:${office.email}`} className="text-blue-500 underline">{office.email}</a></td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><a href={`tel:${office.phoneNumber}`} className="text-blue-500 underline">{office.phoneNumber}</a></td>
